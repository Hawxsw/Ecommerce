  ...
  return (
    <Container>
      ...
      <Right>
        <Title>Contato</Title>
        <ContactItem>
          <Room style={{marginRight:"10px"}}/> 1066 Água santa, Franca - SP
        </ContactItem>
        <ContactItem>
          <Phone style={{marginRight:"10px"}}/> +55 16 988766770
        </ContactItem>
        <ContactItem>
          <MailOutline style={{marginRight:"10px"}} /> williamsilva1942@gmail.com
        </ContactItem>
